...
void main() {
  ...
  print('   শেষ: ${_formatTime(sunsetForbiddenStart)} (সূর্যাস্তের ১৫ মিনিট আগে)');
  print('   ওয়াক্ত রেঞ্জ: ${_formatTime(asr)} - ${_formatTime(sunsetForbiddenStart)}\n');
  ...
  print('   ওয়াক্ত রেঞ্জ: ${_formatTime(isha)} - ${_formatTime(tomorrowFajr)}\n');
  ...
  print('আসর:          ${_formatTime(asr)} → ${_formatTime(sunsetForbiddenStart)}');
  print('নিষিদ্ধ #3:  ${_formatTime(sunsetForbiddenStart)} → ${_formatTime(maghrib)}');
