...
class AppColors {
  ...
  static const Color backgroundLight = Color(
    0xFF1A1A1A,
  ); // Light grey for cards/boxes

  // Light Theme Colors (Premium Soft Ivory — NO PURE WHITE)
  static const Color backgroundLightMode = Color(
    0xFFF2F1EC,
  ); // calm ivory-greige background (less yellow)

  static const Color surfaceLightMode = Color(
    0xFFF7F6F1,
  ); // cards: soft neutral ivory (clean, not white)

  static const Color cardLightMode = Color(
    0xFFFBFAF5,
  ); // inner items: brighter ivory (still not pure white)

  static const Color textLightMode = Color(
    0xFF1F2937,
  ); // professional dark gray (cleaner than brown)

  static const Color textSecondaryLightMode = Color.fromARGB(
    255,
    37,
    36,
    31,
  ...
  static const Color borderLightMode = Color(
    0xFFE6E3DA,
  ); // soft neutral divider tone (if needed)

  static const Color iconBgLightMode = Color(
    0xFFF3EAD1,
  ); // subtle gold-ivory tint (premium, not yellow)
  ...
  static const Color onPrimaryText =
      Colors.white; // Text on primary color (badges, icons)
  static const Color onPrimaryDark = Color(
    0xFF000000,
  ); // Black text on primary (dark theme)
  static const Color onSecondaryDark = Color(
    0xFF000000,
  ); // Black text on secondary (dark theme)
  ...
  static const Color textSecondaryDarkMode = Color.fromARGB(
    255,
    163,
    160,
    149,
  ...
  static const Color onPrimaryTextLight =
      Colors.white; // Text on primary color (light theme)
  ...
  static const lightAppBarBorder = Color.fromARGB(
    101,
    206,
    161,
    15,
  ); // subtle golden 3D border
  ...
  static const lightPremiumBorder = Color(
    0xFFCEA10F,
  ); // primary with 18% opacity applied
  static const lightPremiumOverlay1 = Color(
    0x081F2937,
  ); // onSurface with 3% opacity
  static const lightPremiumNoise = Color(
    0x051F2937,
  ); // onSurface with 2% opacity
  ...
  static const darkPremiumBorder = Color(
    0xFFD4AF37,
  ); // primaryGold with 10% opacity applied
  static const darkPremiumOverlay1 = Color(
    0x0FFFFFFF,
  ); // onSurface with 6% opacity
  static const darkPremiumNoise = Color(
    0x0AFFFFFF,
  ); // onSurface with 4% opacity
